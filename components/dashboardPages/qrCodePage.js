        ...
        <>
            {
                !isLoading ? <div className={`p-4 d-flex flex-column align-items-center justify-content-center ${styles.mainContentForQR}`}>
                    ...
                    <button className={`commonBtnWindo mx-1 my-2 px-4 d-flex felx-row align-items-center justify-content-center `} onClick={routeToLink}>Commander mon support</button>
                </div> : <Loader />
            }
        </>
