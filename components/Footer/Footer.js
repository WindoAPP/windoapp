...
const Footer = () => {
  ...
  const ventes = [
    ...
    },
    {
      ...
      des: `Pou rassurer la promotion du CLIENT , WINDO propose un ensemble de services de marketing digital que le CLIENT sélectionne à la carte. Parmi ces services : -Une animation sous forme de jeu visant à collecter les coordonnées (email ou numéro de portable) des clients du CLIENT en vue de leur envoyer des communications régulières dans une optique de fidélisation. - Une animation visant à transformer les clients du CLIENT en abonnés sur les réseaux sociaux (Facebook, Instagram, Snapchat etc.) - Une animation visant à obtenir des avis positifs ou des abonnées sur les sites de référence (Google, Facebook, Instagram et TikTok.) afin d’améliorer le référencement du CLIENT sur internet. 

      Le CLIENT devra communiquer à WINDO toutes les informations nécessaires à la mise en place de ces services. Le CLIENT est responsable de la disponibilité des éléments qu’il fournit pour le lancement du jeu et sa mise en avant. 
      
      Le CLIENT aura accès au contenu relatif à sa communication sur son Tableau de bord (accès sécurisé via un identifiant email et un mot de passe). Cet identifiant et ce mot de passe sont strictement personnels et confidentiels et ne devront pas être communiqués, ni partagés avec des tiers. 
      
      Le CLIENT assume l’entière responsabilité de l’utilisation, par lui-même et par toutes personnes à qui il a permis d’accéder aux données, des codes d’accès qui lui ont été fournis ou qu’il a pu créer. Les modalités de l’animation restent modifiables par le CLIENT à tout moment (cadeaux offerts, action demandée au client final etc.).`
    },
    {
    ...
    },
    {
      ...
      Dès lors que le CLIENT a donné plusieurs moyens de paiement à WINDO, et si l’un des moyens de paiement ne fonctionne pas,WINDO pourra réaliser une tentative de paiement sur les autres moyens transmis à WINDO. Toute somme non payée à l’échéance donnera lieu au paiement de pénalités de retard fixées à 3 (trois) fois le taux d’intérêt légal par jour de retard. 
      
      Ces pénalités de retard seront dues dès le lendemain de la date d’échéance et seront exigibles sans qu’un rappel ne soit nécessaire, l’envoi d’une lettre recommandée n’étant pas requis pour déclencher le droit pour WINDO de les percevoir. 
      
      Une indemnité forfaitaire de quarante euros(40€) sera également due à WINDO pour frais de recouvrement, à l’occasion de tout retard de paiement ou impayé. 
      
      Cette indemnité est due pour chaque facture payée en retard et non sur l’ensemble des factures concernées. Toute fois, cette indemnité ne s’appliquera pas si le CLIENT est en cours de procédure de sauvegarde, de redressement ou de liquidation judiciaire. 
      
      Si les frais de recouvrement réellement engagés sont supérieurs à ce montant forfaitaire, notamment en cas de recours à un cabinet de recouvrement externe, une indemnisation complémentaire pourra être demandée par WINDO au CLIENT.
      ...
      En cas de défaut de paiement de toute ou partie d’une facture à l’échéance fixée, WINDO aura la faculté d’exiger le règlement immédiat de l’intégralité de la somme due à quelque titre que ce soit, même si elles ne sont pas encore échues et quel que soit le mode de règlement prévu. 
      
      Non obstant ce qui précède, en cas de liquidation judiciaire ou de cession, le Client s’engage à en informer WINDO dans les plus brefs délais. 
      
      Dans cette hypothèse, WINDO constatera la résiliation du Contrat avec le Client sur la base des justifications apportées par le Client et annulera toutes les sommes restantes dues au titre du Contrat par le Client pour la durée restante sur l’abonnement.`
    },
    {
      heading: `ARTICLE 8 - DURÉE DU CONTRAT - RESILIATION`,
      des: `8.1 - Durée du contrat

      Conformément aux dispositions légales en vigueur, LE CLIENT bénéficie d'un droit de rétractation, lui permettant de se rétracter du présent contrat sans donner de motif, dans un délai de 15 jours (quinze jours) à compter de la date de souscription au contrat. Le présent Contrat prend effet à compter de la date indiquée par le client et présente un caractère définitif et irrévocable liant WINDO au CLIENT. 
      
      Au terme de la période d’engagement initialement prévue, l’abonnement au Service WINDO sera reconduit tacitement par périodes successives identiques à la durée de la première souscription sauf dénonciation adressée par le CLIENT et sans période de préavis par email à l’adresse: contact@veryeasyagency.com. Le Contrat ne peut être dénoncé ou résilié avant son terme et/ou de manière unilatérale par le CLIENT, pour quelque cause, fondement ou grief que ce soit. En toute hypothèse, le CLIENT ne peut interrompre l’exécution du Contrat, même ponctuellement, pour des motifs liés à la fermeture temporaire de son établissement (vacances du mois d’août, fermeture annuelle etc.), étant précisé que les périodes de fermeture sont déjà prises en compte par WINDO au moment de la souscription de la commande.
      
      8.2 Résiliation en cours de mois
      
      Le CLIENT reconnaît que la résiliation anticipée de ce contrat en cours de mois entraînera l'obligation de payer le montant total dû pour ce mois en cours. Cette obligation s'applique quel que soit le motif de la résiliation anticipée.`
    },
    {
      heading: `ARTICLE 9 - DONNÉES PERSONNELLES`,
      des: `• Données relatives aux Utilisateurs finaux WINDO agit en qualité de responsable de traitement dans le cadre des services fournis au CLIENT dans la mesure où WINDO détermine de manière autonome les finalités et les moyens des traitements de données personnelles relatifs aux Utilisateurs finaux.
      WINDO s’engage à se conformer aux exigences de la règlementation applicable en matière de protection des données à caractère personnel, notamment le Règlement européen n° 2016-679 du 27 avril 2016 (« RGPD ») et la loi n°78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés.
      • Données relatives au CLIENT WINDO peut également être amené à traiter, en qualité de responsable de traitement, des données personnelles relatives aux employés ou mandataires sociaux du CLIENT limitées principalement aux noms et coordonnées professionnelles pour la gestion de la relation commerciale (gestion de la relation contractuelle, gestion de la facturation...).
      Les données sont archivées pendant 5 ans à compter de la fin de la relation commerciale ou, en tout état de cause, pendant une durée n’excédant pas les délais de prescription légale applicables. 

      • Destinataires et droits des personnes concernées Les Données personnelles traitées par WINDO ne sont cédées, transférées ou rendues accessibles à aucun tiers sous réserve des sous-traitants éventuels de WINDO, situés dans l’EEE et de toute restructuration et/ou toute opération de réorganisation de WINDO ou lorsqu’une telle communication est requise par la loi, une disposition réglementaire ou une décision judiciaire, ou nécessaire pour assurer la protection et la défense de ses droits. Les personnes concernées disposent d’un droit d’accès et de rectification de leurs Données, ainsi que de celui d’en demander l’effacement, de s’opposer à leur traitement et d’en obtenir la limitation ou la portabilité. 
      Ces droits peuvent être exercés seulement par courrier électronique à l’adresse : contact@veryeasyagency.com. 

      • Enfin, pour toute réclamation, le CLIENT dispose du droit de saisir la Commission Nationale de l’Informatique et des Libertés (CNIL).`
    },
    {
